...
printf -- '- Current validation layers: 91-check core suite, 43-case GdUnit4 behavioral pilot, runtime smoke stages 1 and 2\n'
...
printf -- '- tools/validate.sh: Godot detection → headless import/parse → 91-check suite → 43-case GdUnit4 behavioral pilot → smoke stage 1 → smoke stage 2\n'
