...
- GdUnit4 behavioral tests complement the 89-check suite; they do not replace
  it.
...
- `./tools/validate.sh` is the project-wide validation entry point and the
  final local authority for parse/import checks, the 89-check suite, GdUnit4,
...
- Godot AI MCP is the local editor/runtime inspection and gameplay validation
  path.
- The 89-check suite covers the shared headless project rules and data checks.
